...
export declare class UnsupportedInstruction extends Error {
    readonly opcode: number;
    readonly at: number;
    constructor(opcode: number, at: number);
}
/** Thrown on access to an address that maps to neither RAM nor a known device. */
export declare class UnmappedAccess extends Error {
    readonly addr: number;
    readonly isWrite: boolean;
    constructor(addr: number, isWrite: boolean);
}
...
export declare class WindowException extends Error {
    readonly kind: "overflow" | "underflow";
    readonly at: number;
    constructor(kind: "overflow" | "underflow", at: number);
}
